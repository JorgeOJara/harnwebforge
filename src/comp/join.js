...
export const Join = ()=>{
    const enlace = "https://discord.com/api/oauth2/authorize?client_id=1006779722988011592&redirect_uri=https%3A%2F%2Fharnforge.com&response_type=code&scope=identify";
    function login()
{
