...
<div class="card-body">
<ul class="list-group">
   { JSON.parse(ufehieugciu.items).map( d => <li class="list-group-item d-flex justify-content-between align-items-center">Item<span class="badge badge-primary badge-pill">{d.itemName}</span></li>))}
</ul>
</div>
<div class="card-footer text-muted">
